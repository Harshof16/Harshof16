...
|----------------------------|-----------------|----------------------------------------------|------------------------------|
| NoteFlow               | Next.js, LangChain          | Notebook-LM style multi-modal RAG assistant     | [Repo](https://github.com/Harshof16/noteflow_rag) • [Live](https://noteflow-rag.vercel.app/)                    |
